...
MESSAGE("\tCOIN IPOPT BONMIN: ${COIN_IPOPT_LIBRARY}")
...
MESSAGE("\tCOIN OSI BONMIN: ${COIN_BONMIN_LIBRARY}")
...
# the lower line should be commented out and this line used
  ...
  set (COIN_BONMIN_LIBRARIES ${COIN_BONMIN_LIBRARY} ${COIN_IPOPT_LIBRARY} ${COIN_COIN_UTILS_LIBRARY})
  SET(COIN_LIBRARIES ${COIN_CBC_LIBRARIES} ${COIN_BONMIN_LIBRARIES})
ENDIF(COIN_FOUND)
