...
IF(COIN_FOUND)
  ...
  set (COIN_COIN_UTILS_LIBRARIES ${COIN_COIN_UTILS_LIBRARY})
  if (GLPK_LIBRARY)
    list (APPEND COIN_COIN_UTILS_LIBRARIES ${GLPK_LIBRARY})
  endif ()
  if (LAPACK_FOUND)
    list (APPEND COIN_COIN_UTILS_LIBRARIES ${LAPACK_LIBRARIES})
  endif ()
  SET(COIN_CLP_LIBRARIES "${COIN_CLP_LIBRARY};${COIN_COIN_UTILS_LIBRARIES};${COIN_ZLIB_LIBRARY}")
...
# the lower line should be commented out and this line used
  ...
  set (COIN_BONMIN_LIBRARIES ${COIN_BONMIN_LIBRARY} ${COIN_IPOPT_LIBRARY} ${COIN_COIN_UTILS_LIBRARIES} ${COIN_CBC_LIBRARIES})
