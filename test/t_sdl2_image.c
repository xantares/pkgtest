 ...
 * @param y The y coordinate to draw too
 */
void renderTexture_smart(SDL_Texture *tex, SDL_Renderer *ren, int x, int y){
        int w, h;
...
int main(int argc, char** argv){
        ...
        SDL_Texture *background = loadTexture("../test.jpg", renderer);
        SDL_Texture *image = loadTexture("../test.jpg", renderer);
        ...
        renderTexture_smart(image, renderer, x, y);
